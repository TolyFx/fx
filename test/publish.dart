...
void main() async {
  ...
  String projectPath = 'd:\\Projects\\Flutter\\Fx\\toly_ui';
  for(String module in updates){
    await publishModule(projectPath, module);
...
Future<void> publishModule(String projectPath,String module) async{
  String path = p.join(projectPath, 'modules', module);
